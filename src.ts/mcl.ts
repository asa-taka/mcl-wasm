...
import { MCLBN_COMPILED_TIME_VAR, MCLBN_FP_SIZE, MCLBN_FR_SIZE, MCLBN_G1_SIZE, MCLBN_G2_SIZE, MCLBN_GT_SIZE } from './constants'
const createModule = require('./mcl_c.js')

/** @internal MCL WASM module generated by emscripten. */
